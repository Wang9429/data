...
const App = {
  ...
  renderDashboardInsights() {
    ...
    if (insights) insights.innerHTML = `
      <div class="insight-card dense-card"><div class="insight-head"><span>国资监管主题落实</span><button onclick="App.navigate('controls')">查看规则执行 ›</button></div><table class="mini-table"><thead><tr><th>监管主题</th><th>正常</th><th>异常</th><th>未闭环</th></tr></thead><tbody><tr><td>投资方向与主业匹配</td><td>272</td><td class="danger-text">14</td><td>4</td></tr><tr><td>投资决策程序合规</td><td>122</td><td class="danger-text">6</td><td>2</td></tr><tr><td>投资计划执行</td><td>118</td><td class="danger-text">8</td><td>3</td></tr><tr><td>投资后评价</td><td>95</td><td class="danger-text">17</td><td>9</td></tr></tbody></table></div>
      <div class="insight-card dense-card"><div class="insight-head"><span>投资管理领域运行</span><button onclick="App.navigate('portfolio')">查看结构与组合 ›</button></div><div class="board-bars"><p><span>股权投资</span><i><b style="width:76%"></b></i><em>356项</em></p><p><span>固定资产投资</span><i><b style="width:62%"></b></i><em>412项</em></p><p><span>境外投资</span><i><b style="width:48%"></b></i><em>86项</em></p><p><span>投资后评价</span><i><b style="width:32%"></b></i><em>112项</em></p></div><small class="insight-note">关注投资规模变化、计划偏差、业务板块分布、境内外结构和项目退出状态。</small></div>
      <div class="insight-card dense-card"><div class="insight-head"><span>集团投资重点关注</span><button onclick="App.navigate('major')">查看重大事项 ›</button></div><div class="top-scenarios"><button onclick="App.navigate('major')"><b>1</b> 重大投资决策待集团关注 <span class="badge badge-danger">12项</span></button><button onclick="App.navigate('warnings')"><b>2</b> 投资收益偏离项目 <span class="badge badge-danger">31项</span></button><button onclick="App.navigate('warnings')"><b>3</b> 投后管理异常事项 <span class="badge badge-warning">18项</span></button><button onclick="App.navigate('rectification')"><b>4</b> 后评价未完成与长期整改 <span class="badge badge-warning">17项</span></button></div></div>`;
